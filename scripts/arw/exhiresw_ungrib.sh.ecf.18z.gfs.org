...
mv ${mod}.t${cycold}z.${type}12${suf} ./run_ungrib_1/GRIBFILE.AAA
mv ${mod}.t${cycold}z.${type}15${suf} ./run_ungrib_1/GRIBFILE.AAB
mv ${mod}.t${cycold}z.${type}18${suf} ./run_ungrib_1/GRIBFILE.AAC
mv ${mod}.t${cycold}z.${type}21${suf} ./run_ungrib_1/GRIBFILE.AAD
cp ${mod}.t${cycold}z.${type}24${suf} ./run_ungrib_1/GRIBFILE.AAE

mv ${mod}.t${cycold}z.${type}24${suf} ./run_ungrib_2/GRIBFILE.AAA
mv ${mod}.t${cycold}z.${type}27${suf} ./run_ungrib_2/GRIBFILE.AAB
mv ${mod}.t${cycold}z.${type}30${suf} ./run_ungrib_2/GRIBFILE.AAC
mv ${mod}.t${cycold}z.${type}33${suf} ./run_ungrib_2/GRIBFILE.AAD
cp ${mod}.t${cycold}z.${type}36${suf} ./run_ungrib_2/GRIBFILE.AAE

mv ${mod}.t${cycold}z.${type}36${suf} ./run_ungrib_3/GRIBFILE.AAA
mv ${mod}.t${cycold}z.${type}39${suf} ./run_ungrib_3/GRIBFILE.AAB
mv ${mod}.t${cycold}z.${type}42${suf} ./run_ungrib_3/GRIBFILE.AAC
mv ${mod}.t${cycold}z.${type}45${suf} ./run_ungrib_3/GRIBFILE.AAD
cp ${mod}.t${cycold}z.${type}48${suf} ./run_ungrib_3/GRIBFILE.AAE

mv ${mod}.t${cycold}z.${type}48${suf} ./run_ungrib_4/GRIBFILE.AAA
mv ${mod}.t${cycold}z.${type}51${suf} ./run_ungrib_4/GRIBFILE.AAB
mv ${mod}.t${cycold}z.${type}54${suf} ./run_ungrib_4/GRIBFILE.AAC
mv ${mod}.t${cycold}z.${type}57${suf} ./run_ungrib_4/GRIBFILE.AAD
mv ${mod}.t${cycold}z.${type}60${suf} ./run_ungrib_4/GRIBFILE.AAE
