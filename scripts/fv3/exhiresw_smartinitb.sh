...
# 2019-11-13  Matthew Pyle  - Adapted for regional FV3
#
...
do
 ...
 if [ $loop -ge $looplim ]
   then
   msg="FATAL ERROR: ABORTING after 30 minutes of waiting for $INPUT_DATA/smartinitprdgendone${hr}"
   err_exit $msg
 fi
done
...
$USHfv3/hiresw_smartinit_smartinit.sh 
