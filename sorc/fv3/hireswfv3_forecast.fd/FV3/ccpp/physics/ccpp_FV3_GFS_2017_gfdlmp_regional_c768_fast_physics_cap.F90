...
!>
!! @brief Auto-generated cap module for the CCPP fast_physics group
!!
!
module ccpp_FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_cap
   ...
   private
   public :: FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_init_cap, &
             FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_run_cap, &
             FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_init_cap(cdata,CCPP_interstitial) result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_init_cap

   function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_run_cap(cdata,CCPP_interstitial) result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_run_cap

   function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_finalize_cap

end module ccpp_FV3_GFS_2017_gfdlmp_regional_c768_fast_physics_cap
