...
!!
!
module ccpp_FV3_GFS_2017_gfdlmp_regional_cap
   ...
   private
   public :: FV3_GFS_2017_gfdlmp_regional_init_cap, &
             FV3_GFS_2017_gfdlmp_regional_run_cap, &
             FV3_GFS_2017_gfdlmp_regional_finalize_cap

   contains

   function FV3_GFS_2017_gfdlmp_regional_init_cap(GFS_Data,GFS_Control,CCPP_interstitial,con_p0,GFS_Interstitial,cdata) result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_init_cap

   function FV3_GFS_2017_gfdlmp_regional_run_cap(con_t0c,con_rd,LTP,rlapse,con_hvap,con_eps,GFS_Data,con_g,con_pi,cimin, &
   ...
   end function FV3_GFS_2017_gfdlmp_regional_run_cap

   function FV3_GFS_2017_gfdlmp_regional_finalize_cap(cdata) result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_finalize_cap

end module ccpp_FV3_GFS_2017_gfdlmp_regional_cap
