...
!!
!
module ccpp_FV3_GFS_2017_gfdlmp_regional_radiation_cap
   ...
   private
   public :: FV3_GFS_2017_gfdlmp_regional_radiation_init_cap, &
             FV3_GFS_2017_gfdlmp_regional_radiation_run_cap, &
             FV3_GFS_2017_gfdlmp_regional_radiation_finalize_cap

   logical, save :: initialized = .false.

   contains

   function FV3_GFS_2017_gfdlmp_regional_radiation_init_cap() result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_radiation_init_cap

   function FV3_GFS_2017_gfdlmp_regional_radiation_run_cap(GFS_Data,GFS_Control,con_epsm1,con_rog,GFS_Interstitial,con_rd,LTP,con_rocp, &
   ...
   end function FV3_GFS_2017_gfdlmp_regional_radiation_run_cap

   function FV3_GFS_2017_gfdlmp_regional_radiation_finalize_cap() result(ierr)
   ...
   end function FV3_GFS_2017_gfdlmp_regional_radiation_finalize_cap

end module ccpp_FV3_GFS_2017_gfdlmp_regional_radiation_cap
