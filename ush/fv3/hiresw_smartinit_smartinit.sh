...
# 2026-09-22  Matthew Pyle : Mods for Guam-only in RRFS era
#======================================================================
...
outreg=$rg
case $RUNTYP in
  guamarw|guamfv3) rg=guam; outres="2p5km"; outreg=guam; wgrib2def="mercator:20 143.687:193:2500:148.280 12.35:193:2500:16.794";;
esac
...
#   sgrb : Input SREF grid grib number (eg: 999 = Guam)
...
#    No special data needed
       ...
       if [ $RUNTYP = "guamarw" -a $fhr -lt 24 ];then
         mksmart=1
       else
         mksmart=0
       fi
